...
%\begin{table}[!h]
    ...
    Pteridaceae (鳳尾蕨科) & \textit{Adiantum meishanianum}  & 梅山口鐵線蕨 & B1ab(iii)+2ab(iii); C2a(ii) \index{Adiantum@\textit{Adiantum}!meishanianum@\textit{meishanianum}}  \index{梅山口鐵線蕨} \\
    ...
    Woodsiaceae (岩蕨科) & \textit{Woodsia andersonii}  & 蜘蛛岩蕨 & ? \index{Woodsia@\textit{Woodsia}!andersonii@\textit{andersonii}}  \index{蜘蛛岩蕨} \\
