  ...
  \begin{itemize}
 \item[] \textit{Arenaria}\index{Arenaria@\textit{Arenaria}} 無心菜屬
  ...
  \end{itemize}
 \item[] \textit{Cerastium}\index{Cerastium@\textit{Cerastium}} 卷耳屬
  ...
  \end{itemize}
 \item[] \textit{Cucubalus}\index{Cucubalus@\textit{Cucubalus}} 狗筋蔓屬
                                
  \begin{itemize}
        \item[] \textit{C. baccifer} L. \index{Cucubalus@\textit{Cucubalus}!baccifer@\textit{baccifer}} 狗筋蔓 \index{狗筋蔓}  LC
  \end{itemize}
 \item[] \textit{Dianthus}\index{Dianthus@\textit{Dianthus}} 石竹屬
  ...
  \begin{itemize}
        ...
        \item[] \textit{D. pygmaeus} Hayata f. albiflorus (S. S. Ying) S. S. Ying \index{Dianthus@\textit{Dianthus}!pygmaeus@\textit{pygmaeus}} 白花玉山石竹 \index{白花玉山石竹} \# DD
 ...
 \item[] \textit{Sagina}\index{Sagina@\textit{Sagina}} 瓜槌草屬
  ...
  \end{itemize}
 \item[] \textit{Silene}\index{Silene@\textit{Silene}} 蠅子草屬
                                
  \begin{itemize}
        \item[] \textit{S. fortunei} Vis. \index{Silene@\textit{Silene}!fortunei@\textit{fortunei}} 蠅子草 \index{蠅子草}  LC
        \item[] \textit{S. fortunei} var. \textit{kiruninsularis} (Masamune) S. S. Ying \index{Silene@\textit{Silene}!fortunei@\textit{fortunei}!var. kiruninsularis@var. \textit{kiruninsularis}} 基隆蠅子草 \index{基隆蠅子草} \# EN
