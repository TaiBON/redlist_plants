 ...
 \item[] \textit{Begonia} 秋海棠屬
  ...
  \begin{itemize}
        ...
        \item[] \href{http://www.theplantlist.org/tpl1.1/search?q=Begonia+formosana+fo.+albomaculata}{\textit{B. formosana} (Hayata) Masam. fo. \textit{albomaculata} T.S.Liu \& M.J.Lai}  \index{Begonia@\textit{Begonia}!formosana@\textit{formosana}!fo. albomaculata@fo. \textit{albomaculata}} 白斑水鴨腳 \index{白斑水鴨腳} \# NA (F)
