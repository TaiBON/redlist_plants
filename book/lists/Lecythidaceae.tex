 ...
 \item[] \textit{Barringtonia} 棋盤腳樹屬
  ...
  \begin{itemize}
        ...
        \item[] \href{http://www.theplantlist.org/tpl1.1/search?q=Barringtonia+racemosa}{\textit{B. racemosa} (L.) Blume ex DC.}  \index{Barringtonia@\textit{Barringtonia}!racemosa@\textit{racemosa}} 水茄苳 \index{水茄苳}  VU
  \end{itemize}
  \end{itemize}
