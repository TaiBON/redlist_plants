 ...
 \item[] \textit{Synostemon} 假葉下珠屬
  ...
  \begin{itemize}
        \item[] \href{http://www.theplantlist.org/tpl1.1/search?q=Synostemon+bacciforme}{\textit{S. bacciforme} (L.) G.L.Webster}  \index{Synostemon@\textit{Synostemon}!bacciforme@\textit{bacciforme}} 假葉下珠 \index{假葉下珠}  LC
  \end{itemize}
  \end{itemize}
