 ...
 \item[] \textit{Cardiandra} 草紫陽花屬
  ...
  \begin{itemize}
        \item[] \href{http://www.theplantlist.org/tpl1.1/search?q=Cardiandra+formosana}{\textit{C. formosana} Hayata*}  \index{Cardiandra@\textit{Cardiandra}!formosana@\textit{formosana}} 臺灣草紫陽花\index{臺灣草紫陽花}\# LC
  \end{itemize}
 ...
 \item[] \textit{Pileostegia} 青棉花屬
  ...
  \begin{itemize}
        \item[] \href{http://www.theplantlist.org/tpl1.1/search?q=Pileostegia+viburnoides}{\textit{P. viburnoides} Hook.f. \& Thomson*}  \index{Pileostegia@\textit{Pileostegia}!viburnoides@\textit{viburnoides}} 青棉花\index{青棉花} LC
  \end{itemize}
 \item[] \textit{Schizophragma} 鑽地風屬
                    
  \begin{itemize}
        \item[] \href{http://www.theplantlist.org/tpl1.1/search?q=Schizophragma+integrifolium+var.+fauriei}{\textit{S. integrifolium} Oliv. var. \textit{fauriei} (Hayata) Hayata*}  \index{Schizophragma@\textit{Schizophragma}!integrifolium@\textit{integrifolium}!var. fauriei@var. \textit{fauriei}} 圓葉鑽地風\index{圓葉鑽地風}\# LC
  \end{itemize}
  \end{itemize}
