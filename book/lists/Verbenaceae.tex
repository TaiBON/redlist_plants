 ...
 \item[] \textit{Duranta} 假連翹屬
  ...
  \begin{itemize}
        \item[] \textit{D. erecta} L. \index{Duranta@\textit{Duranta}!erecta@\textit{erecta}} 金露花 \index{金露花}  NA
  \end{itemize}
 ...
 \item[] \textit{Stachytarpheta} 木馬鞭屬
  ...
  \begin{itemize}
        \item[] \textit{S. cayennensis} (Rich.) Vahl \index{Stachytarpheta@\textit{Stachytarpheta}!cayennensis@\textit{cayennensis}} 藍蝶猿尾木 \index{藍蝶猿尾木}  NA
