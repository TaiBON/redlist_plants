 ...
 \item[] \textit{Crocosmia} 雄黃蘭屬
  ...
  \begin{itemize}
        \item[] \textit{C.} × \textit{crocosmiiflora} crocosmiiflora (Lemoine) N.E.Br. \index{Crocosmia@\textit{Crocosmia}!× crocosmiiflora@× \textit{crocosmiiflora}} 觀音蘭 \index{觀音蘭}  NA
  \end{itemize}
 \item[] \textit{Iris} 鳶尾屬
                                
  \begin{itemize}
        \item[] \textit{I. domestica} (L.) Goldblatt \& Mabb. \index{Iris@\textit{Iris}!domestica@\textit{domestica}} 射干 \index{射干}  LC
