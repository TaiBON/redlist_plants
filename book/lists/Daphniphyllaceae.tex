 ...
 \item[] \textit{Daphniphyllum} 虎皮楠屬
  ...
  \begin{itemize}
        \item[] \textit{D. glaucescens} subsp. \textit{oldhamii} (Hemsl.) T.C.Huang \index{Daphniphyllum@\textit{Daphniphyllum}!glaucescens@\textit{glaucescens}!subsp. oldhamii@subsp. \textit{oldhamii}} 奧氏虎皮楠 \index{奧氏虎皮楠}  LC
