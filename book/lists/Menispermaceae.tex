 ...
 \item[] \textit{Paratinospora} 擬青牛膽屬
  ...
  \begin{itemize}
        \item[] \href{http://www.theplantlist.org/tpl1.1/search?q=Paratinospora+dentata}{\textit{P. dentata} (Diels) Wei Wang}  \index{Paratinospora@\textit{Paratinospora}!dentata@\textbf{\textit{dentata}}}  \index{Tinospora@\textit{Tinospora}!dentata@\textit{dentata}{\\\noindent(= \textit{Paratinospora dentata})}} \href{\detokenize{http://taibnet.sinica.edu.tw/chi/taibnet_species_list.php?T2=恆春青牛膽&T2_new_value=true&fr=y}}{恆春青牛膽}\index{恆春青牛膽@{\Song{恆春青牛膽}}}\# EN
  \end{itemize}
