  ...
  \begin{itemize}
 \item[] \textit{Lindsaea}\index{Lindsaea@\textit{Lindsaea}} 陵齒蕨屬
  ...
  \begin{itemize}
        ...
        \item[] \textit{L. heterophylla} Dryand. \index{Lindsaea@\textit{Lindsaea}!heterophylla@\textit{heterophylla}} 異葉陵齒蕨 \index{異葉陵齒蕨}  NA
        ...
        \item[] \textit{L. orbiculata} (Lam.) Mett. ex Kuhn \index{Lindsaea@\textit{Lindsaea}!orbiculata@\textit{orbiculata}} 圓葉陵齒蕨 \index{圓葉陵齒蕨}  LC
  ...
  \end{itemize}
 \item[] \textit{Odontosoria}\index{Odontosoria@\textit{Odontosoria}} Odontosoria屬
  ...
  \begin{itemize}
        ...
        \item[] \textit{O. gracilis} (Tagawa) Ralf Knapp \index{Odontosoria@\textit{Odontosoria}!gracilis@\textit{gracilis}} 小烏蕨
 \index{小烏蕨
}  NT
  ...
  \end{itemize}
 \item[] \textit{Osmolindsaea}\index{Osmolindsaea@\textit{Osmolindsaea}} Osmolindsaea屬
  ...
  \end{itemize}
 \item[] \textit{Tapeinidium}\index{Tapeinidium@\textit{Tapeinidium}} 達邊蕨屬
                                
  \begin{itemize}
        \item[] \textit{T. pinnatum} (Cav.) C.Chr. \index{Tapeinidium@\textit{Tapeinidium}!pinnatum@\textit{pinnatum}} 達邊蕨 \index{達邊蕨}  LC
