  ...
  \begin{itemize}
 \item[] \textit{Biophytum}\index{Biophytum@\textit{Biophytum}} 羞禮花屬
                                
  \begin{itemize}
        \item[] \textit{B. sensitivum} DC. \index{Biophytum@\textit{Biophytum}!sensitivum@\textit{sensitivum}} 羞禮花 \index{羞禮花}  LC
  \end{itemize}
 \item[] \textit{Oxalis}\index{Oxalis@\textit{Oxalis}} 酢漿草屬
  ...
  \begin{itemize}
        ...
        \item[] \textit{O. acetosella} subsp. \textit{taemoni} (Yamam.) S. F. Huang \& T. C. Huang \index{Oxalis@\textit{Oxalis}!acetosella@\textit{acetosella}!subsp. taemoni@subsp. \textit{taemoni}} 大霸尖山酢醬草 \index{大霸尖山酢醬草} \# VU
