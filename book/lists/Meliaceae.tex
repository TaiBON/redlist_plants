 ...
 \item[] \textit{Swietenia} 桃花心木屬
  ...
  \begin{itemize}
        ...
        \item[] \href{http://www.theplantlist.org/tpl1.1/search?q=Swietenia+mahagoni}{\textit{S. mahagoni} (L.) Jacq.}  \index{Swietenia@\textit{Swietenia}!mahagoni@\textit{mahagoni}} 桃花心木 \index{桃花心木}  NA (N)
  \end{itemize}
  \end{itemize}
