  ...
  \begin{itemize}
 \item[] \textit{Legazpia}\index{Legazpia@\textit{Legazpia}} 三翅萼屬
                                
  \begin{itemize}
        \item[] \textit{L. polygonoides} (Benth.) Yamaz. \index{Legazpia@\textit{Legazpia}!polygonoides@\textit{polygonoides}} 三翅萼 \index{三翅萼}  VU
  \end{itemize}
 \item[] \textit{Lindernia}\index{Lindernia@\textit{Lindernia}} 母草屬
  ...
  \begin{itemize}
        ...
        \item[] \textit{L. scutellariiformis} Yamazaki \index{Lindernia@\textit{Lindernia}!scutellariiformis@\textit{scutellariiformis}} 臺南見風紅 \index{臺南見風紅} \# EN
  ...
  \end{itemize}
 \item[] \textit{Micranthemum}\index{Micranthemum@\textit{Micranthemum}} Micranthemum屬
  ...
  \end{itemize}
 \item[] \textit{Torenia}\index{Torenia@\textit{Torenia}} 倒地蜈蚣屬
  ...
  \begin{itemize}
        ...
        \item[] \textit{T. fournieri} L. \index{Torenia@\textit{Torenia}!fournieri@\textit{fournieri}} 夏堇 \index{夏堇}  NA
