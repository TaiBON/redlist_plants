  ...
  \begin{itemize}
 \item[] \textit{Anisocampium}\index{Anisocampium@\textit{Anisocampium}} Anisocampium屬
  ...
  \end{itemize}
 \item[] \textit{Athyrium}\index{Athyrium@\textit{Athyrium}} 蹄蓋蕨屬
  ...
  \begin{itemize}
        ...
        \item[] \textit{A. oppositipinnum} Hayata \index{Athyrium@\textit{Athyrium}!oppositipinnum@\textit{oppositipinnum}} 對生蹄蓋蕨 \index{對生蹄蓋蕨}  LC
  ...
  \end{itemize}
 \item[] \textit{Cornopteris}\index{Cornopteris@\textit{Cornopteris}} 角蕨屬
  ...
  \begin{itemize}
        ...
        \item[] \textit{C. decurrenti-alata} (Hook.) Nakai \index{Cornopteris@\textit{Cornopteris}!decurrenti-alata@\textit{decurrenti-alata}} 貞蕨 \index{貞蕨}  LC
  ...
  \end{itemize}
 \item[] \textit{Deparia}\index{Deparia@\textit{Deparia}} 假鱗毛蕨屬
  ...
  \end{itemize}
 \item[] \textit{Diplazium}\index{Diplazium@\textit{Diplazium}} 雙蓋蕨屬
  ...
  \begin{itemize}
        ...
        \item[] \textit{D. donianum} (Mett.) Tardieu \index{Diplazium@\textit{Diplazium}!donianum@\textit{donianum}} 細柄雙蓋蕨 \index{細柄雙蓋蕨}  LC
        ...
        \item[] \textit{D. esculentum} (Retz.) Sw. \index{Diplazium@\textit{Diplazium}!esculentum@\textit{esculentum}} 過溝菜蕨 \index{過溝菜蕨}  LC
        \item[] \textit{D. esculentum} var. \textit{pubescens} (Link) Tardieu et C. Chr \index{Diplazium@\textit{Diplazium}!esculentum@\textit{esculentum}!var. pubescens@var. \textit{pubescens}}
