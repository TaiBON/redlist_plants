 ...
 \item[] \textit{Gastrodia} 赤箭屬
  ...
  \begin{itemize}
        ...
        \item[] \href{http://www.theplantlist.org/tpl1.1/search?q=Gastrodia+flabilabella}{\textit{G. flabilabella} S.S.Ying}  \index{Gastrodia@\textit{Gastrodia}!flabilabella@\textit{flabilabella}}  \index{Gastrodia@\textit{Gastrodia}!flavilabella@\textit{flavilabella}{\\\noindent(= \textit{Gastrodia flabilabella})}} 夏赤箭\index{夏赤箭}\# VU
 ...
 \item[] \textit{Liparis} 羊耳蘭屬
  ...
  \begin{itemize}
        ...
        \item[] \href{http://www.theplantlist.org/tpl1.1/search?q=Liparis+caespitosa}{\textit{L. caespitosa} (Thouars) Lindl.}  \index{Liparis@\textit{Liparis}!caespitosa@\textit{caespitosa}}  \index{Liparis@\textit{Liparis}!cespitosa@\textit{cespitosa}{\\\noindent(= \textit{Liparis caespitosa})}} 小花羊耳蒜\index{小花羊耳蒜} EN
