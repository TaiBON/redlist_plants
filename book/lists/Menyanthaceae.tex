 ...
 \item[] \textit{Nymphoides} 莕菜屬
  ...
  \begin{itemize}
        ...
        \item[] \href{http://www.theplantlist.org/tpl1.1/search?q=Nymphoides+coreana}{\textit{N. coreana} (H.Lév.) H.Hara}  \index{Nymphoides@\textit{Nymphoides}!coreana@\textbf{\textit{coreana}}} \href{\detokenize{http://taibnet.sinica.edu.tw/chi/taibnet_species_list.php?T2=小莕菜&T2_new_value=true&fr=y}}{小莕菜}\index{小莕菜@{\Song{小莕菜}}} VU
