  ...
  \begin{itemize}
 \item[] \textit{Nymphoides}\index{Nymphoides@\textit{Nymphoides}} 莕菜屬
  ...
  \begin{itemize}
        ...
        \item[] \textit{N. peltata} (S. G. Gmel.) Kuntze \index{Nymphoides@\textit{Nymphoides}!peltata@\textit{peltata}} 荇菜 \index{荇菜}  NA
  \end{itemize}
  \end{itemize}
