 ...
 \item[] \textit{Diplopterygium} 裏白屬
  ...
  \begin{itemize}
        ...
        \item[] \href{http://www.theplantlist.org/tpl1.1/search?q=Diplopterygium+laevissimum}{\textit{D. laevissimum} (Christ) Nakai}  \index{Diplopterygium@\textit{Diplopterygium}!laevissimum@\textit{laevissimum}} \href{\detokenize{http://taibnet.sinica.edu.tw/chi/taibnet_species_list.php?T2=鱗芽裏白&T2_new_value=true&fr=y}}{鱗芽裏白}\index{鱗芽裏白} LC
  \end{itemize}
  \end{itemize}
