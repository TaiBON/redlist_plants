  ...
  \begin{itemize}
 \item[] \textit{Potamogeton}\index{Potamogeton@\textit{Potamogeton}} 眼子菜屬
  ...
  \end{itemize}
 \item[] \textit{Stuckenia}\index{Stuckenia@\textit{Stuckenia}} Stuckenia屬
                                
  \begin{itemize}
        \item[] \textit{S. pectinata} (L.) Boerner \index{Stuckenia@\textit{Stuckenia}!pectinata@\textit{pectinata}} 龍鬚草 \index{龍鬚草}  LC
  \end{itemize}
 \item[] \textit{Zannichellia}\index{Zannichellia@\textit{Zannichellia}} 角果藻屬
