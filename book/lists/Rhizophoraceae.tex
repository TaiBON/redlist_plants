 ...
 \item[] \textit{Bruguiera} 木欖屬
  ...
  \begin{itemize}
        \item[] \href{http://www.theplantlist.org/tpl1.1/search?q=Bruguiera+gymnorhiza}{\textit{B. gymnorhiza} (L.) Savigny}  \index{Bruguiera@\textit{Bruguiera}!gymnorhiza@\textit{gymnorhiza}} \href{\detokenize{http://taibnet.sinica.edu.tw/chi/taibnet_species_list.php?T2=紅茄冬&T2_new_value=true&fr=y}}{紅茄冬}\index{紅茄冬} RE
  \end{itemize}
