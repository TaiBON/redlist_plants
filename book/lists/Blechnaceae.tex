 ...
 \item[] \textit{Cleistoblechnum}\index{Cleistoblechnum@\textit{Cleistoblechnum}} Cleistoblechnum屬
  ...
  \end{itemize}
 \item[] \textit{Diploblechnum}\index{Diploblechnum@\textit{Diploblechnum}} 掃把蕨屬
                                
  \begin{itemize}
        \item[] \textit{D. fraseri} (A.Cunn.) DeVol \index{Diploblechnum@\textit{Diploblechnum}!fraseri@\textit{fraseri}} 假桫欏 \index{假桫欏}  CR
  \end{itemize}
 \item[] \textit{Struthiopteris}\index{Struthiopteris@\textit{Struthiopteris}} 莢囊蕨屬
  ...
  \end{itemize}
 \item[] \textit{Woodwardia}\index{Woodwardia@\textit{Woodwardia}} 狗脊屬
