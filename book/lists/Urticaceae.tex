 ...
 \item[] \textit{Boehmeria} 苧麻屬
  ...
  \begin{itemize}
        ...
        \item[] \textit{B. nivea} var. \textit{nivea}  \index{Boehmeria@\textit{Boehmeria}!nivea@\textit{nivea}!var. nivea@var. \textit{nivea}} 苧麻 \index{苧麻}  NA
 ...
 \item[] \textit{Elatostema} 樓梯草屬
  ...
  \begin{itemize}
        ...
        \item[] \textit{E. trilobulatum} (Hayata) T.Yamaz. \index{Elatostema@\textit{Elatostema}!trilobulatum@\textit{trilobulatum}} 裂葉樓梯草 \index{裂葉樓梯草} \# LC
 ...
 \item[] \textit{Pilea} 冷水麻屬
  ...
  \begin{itemize}
        ...
        \item[] \textit{P. peploides} var. \textit{peploides}  \index{Pilea@\textit{Pilea}!peploides@\textit{peploides}!var. peploides@var. \textit{peploides}} 矮冷水麻 \index{矮冷水麻}  LC
