...
\newcommand\frameboxl[1]{%
  \fcolorbox{myred}{myred}{\makebox[2cm][l]{\textcolor{white}{\bfseries#1}}}%
}

\newcommand\frameboxr[1]{%
  \fcolorbox{myred}{myred}{\makebox[2cm][r]{\textcolor{white}{\bfseries#1}}}%
}
...
\titleformat*{\chapter}{\normalfont\huge\Kai\color{myred}}
\titleformat*{\section}{\normalfont\Large\Kai\color{myred}}
\usepackage{tabu}
...
\begin{document}
    ...
    \begin{footnotesize}
    \pagestyle{memoirStylePages}
    因篇幅關係，僅列出種及種下單位之學名不含作者。括號內的學名代表該分類群在本名錄中所接受的學名(中名索引亦同)。\\
    例如：\\
