...
結果臺灣有 26 種野生維管束植物已經滅絕，其中 %i 種屬於野外絕滅(Extinct in the Wild)，
...
''' % (alltaxa, na, evaluated, ew, re, threatened, cr, en, vu, nt, dd, lc, national_threatened_ratio, national_nt_ratio)

    RESULT_STATS = '''臺灣的野生維管束植物共 %i 分類群，
其中 %i 分類群不適用(Not Applicable)區域評估篩選條件，
%i 分類群進入評估流程。評估的結果顯示臺灣有 26 種野生維管束植物已經滅絕，
